...
HD_PWD='D:/assignment/computerOrganization_LabWork/ex_1/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log app.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source app.tcl -notrace
